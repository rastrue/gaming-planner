  ...
  if (reviewable.length === 0) {
    return (
      <Card
        ...
        description="Approve or decline player applications before assigning them to slots."
      >
        <p className="text-sm text-slate-600 dark:text-slate-400">
          No pending or approved registrations to review.
        </p>
      </Card>
    );
  }
      ...
      >
        <p className="text-sm text-slate-600 dark:text-slate-400">
          {confirmTarget?.action === 'decline'
            ...
            : `Cancel the approved registration for ${confirmTarget?.registration.user.displayName}? The player will be removed from their assigned slot.`}
        </p>
      </ModalDialog>
    </>
  );
